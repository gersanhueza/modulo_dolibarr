...
llxHeader("", $langs->trans("DATA TABLE"));

print load_fiche_titre($langs->trans("DATA TABLE"), '', 'agente.png@agente');
...
<head>
    ...
    <title>REGISTROS INGRESADOS</title>
    ...
    <div class="container-fluid my-2">
        ...
        <div class="container-fluid mt-5 p-0">
            ...
            <div class="row p-0">
                ...
                <table id="tablero_rellamada" class="display" style="width:100%">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th><strong>FECHA HORA LLAMADA</strong></th>
